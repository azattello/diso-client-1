...
const TrackList = () => {
    ...
    const fetchBookmarksWithoutStatus = async () => {
        try {
            ...
            setIsBookmarksVisible(!isBookmarksVisible); // Показываем блок с закладками
        } catch (error) {
                        ...
                        <div className="table-user">
                            <table className="table">
                                ...
                                {tracks.map((track, index) => (
                                    ...
                                    <td>
                                        <button className='change-track-button' onClick={() => handleChangeBookmark(track.track)}>Изменить</button>
                                    </td>
                                    </tr>
                                ))}
                                </tbody>
                                    ...
                                    <tbody>
                                        {bookmarksWithoutStatus.map((bookmark, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <button className='change-track-button' onClick={() => handleAddBookmark(bookmark.trackNumber)}>Добавить</button>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
